...
| `fm-fleet-usage.sh`      | Print one table of LLM usage windows and signed-in accounts across every second-mate host and this one, with an attention section for unmeasurable or unreachable hosts |
